package com.example.qiangge.torrtest.core;/*
...
import com.example.qiangge.torrtest.core.storage.TorrentStorage;
import com.example.qiangge.torrtest.core.utils.TorrentUtils;
import com.example.qiangge.torrtest.core.utils.Utils;
...
public class TorrentEngine extends SessionManager
{
    ...
    private void handleMetadata(MetadataReceivedAlert metadataAlert)
    {
        ...
        if (bencode != null)
            Log.e("xxxxxxxxxxxxxxxx","数据出来了"+new String(bencode));
